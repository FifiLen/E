...
export default function HipoterapiaPage() {
  return (
        ...
        <main>
          ...
          <section className="mb-24">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div>
                ...
                <p className="text-lg">
                  A co byłoby, gdybyś mógł przenieść się ze swoim dzieckiem choć
                  na chwilę do cudownej krainy Nibyladnii? Do miejsca pełnego
                  zieleni, wypełnionego ciepłem, miękkością, łagodnością i
                  kołysaniem? To nie takie trudne… to tylko świat widziany z
                  perspektywy końskiego grzbietu.
                </p>
                <p className="text-lg mt-4">
                  ...
                  doświadczenie, jakim jest spotkanie z mądrością, łagodnością i
                  potęgą spokoju mieszkającą w sercu każdego konia.
                </p>
                <p className="text-lg mt-4">
                  Dzięki sile i opanowaniu zwierzęcych gospodarzy Nibylandii,
                  dzieci zmagające się z dolegliwościami ze strony układu ruchu,
                  trudnościami emocjonalnymi, deficytami uwagi czy problemami z
                  komunikacją z otoczeniem, robią olbrzymie kroki w kierunku
                  pokonania własnych słabości. Zarówno dzieci jak i rodzice
                  zdobywają w Nibyladnii motywację do dalszych wysiłków.
                </p>
                <Button
                  variant={"outline"}
          ...
          <section className="mb-24 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 max-w-6xl mx-auto items-center">
            ...
            <div className=" col-span-1">
              ...
              <p className="text-lg">
                ...
                na potrzeby dzieci organizują serie ćwiczeń rehabilitacyjnych i
                sesje relaksacji na końskim grzbiecie.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-lg">
              ...
              pewność siebie. Kontakt z końmi sprzyja relaksacji, buduje więź i
              pozytywnie wpływa na samopoczucie. <br />
